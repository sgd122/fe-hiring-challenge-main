...
- **AI usage record:** [`docs/AI_USAGE.md`](docs/AI_USAGE.md)
- **Refactor diary (legacy bugs and how each was fixed):** [`docs/REFACTOR_NOTES.md`](docs/REFACTOR_NOTES.md)

### Stack

- React 19 + TypeScript + Vite 8
- **Zustand** for filter state (URL-backed, no browser storage)
- **TanStack Query** for the contents API lifecycle
- **Vitest + React Testing Library** for unit and component tests
- `@emotion/styled` retained for the header / search shell and the empty-state component; the rest of the new components use plain global CSS files (`Content.css`, `Filter.css`)
